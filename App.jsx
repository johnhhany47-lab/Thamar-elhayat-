...
export default function App() {
  const [step, setStep] = useState("form"); // form | success | already_registered
  ...
  useEffect(() => {
    ...
    if (registered) setStep("already_registered");
  }, []);
  ...
  const titleStyle = {
    ...
    margin: "0 0 8px",
    lineHeight: 1.15,
    textShadow: "0 0 40px rgba(99,179,237,0.3)",
  };
      ...
      <div style={bg}>
        <div style={{ ...header }}>
          ...
          <p style={subtitleStyle}>
            إجمالي المسجلين: <strong style={{ color: "#ffc832" }}>{registrations.length}</strong>
          </p>
        </div>
        <div style={{ width: "100%", maxWidth: "800px", padding: "0 16px 40px" }}>
          {registrations.length === 0 ? (
            ...
            registrations.map((r, i) => (
              ...
              >
                <span style={{ background: "rgba(255,200,50,0.15)", color: "#ffc832", borderRadius: "8px", padding: "4px 12px", fontWeight: "700", fontSize: "14px" }}>
                  #{i + 1}
                </span>
                <div style={{ flex: 1, minWidth: "200px" }}>
                  ...
                  <div style={{ color: "rgba(255,255,255,0.5)", fontSize: "13px", marginTop: "2px" }}>
                    {r.phone} · السن: {r.age} · دعاه: {r.invitedBy}
                  </div>
                </div>
          ...
          <button onClick={() => setAdminMode(false)} style={{ ...btn, background: "rgba(255,255,255,0.1)", color: "#fff", marginTop: "16px" }}>
            رجوع
          </button>
        </div>
      </div>
      ...
      <div style={bg}>
        ...
        <div style={{ ...card, textAlign: "center" }}>
          <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "15px", lineHeight: 1.8 }}>
            إذا كنت تعتقد أن هناك خطأ، يرجى التواصل مع منظمي المؤتمر.
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div style={bg}>
        <div style={header}>
          ...
          <p style={{ ...subtitleStyle, maxWidth: "400px", margin: "0 auto 40px" }}>
            أهلاً <strong style={{ color: "#ffc832" }}>{form.fullName.split(" ")[0]}</strong>!
            <br />تسجيلك في المؤتمر تم بنجاح، نتمنى لك تجربة رائعة.
          </p>
        </div>
        <div style={{ ...card, textAlign: "center" }}>
    ...
    <div style={bg}>
      ...
      <div style={card}>
        ...
        <div style={fieldGroup}>
          ...
          <input
            style={{ ...inputStyle(errors.phone), direction: "ltr", textAlign: "right" }}
            type="tel"
        ...
        <div style={fieldGroup}>
          ...
          <input
            style={inputStyle(errors.invitedBy)}
            type="text"
            placeholder="اسم الشخص الذي دعاك"
        ...
        <div style={fieldGroup}>
          ...
          <input
            style={{ ...inputStyle(errors.age), direction: "ltr", textAlign: "right" }}
            type="number"
            placeholder=""
            min="1"
            max="100"
      ...
      <div style={{ marginBottom: "30px" }}>
        {!showAdmin ? (
          <button
            ...
            style={{ background: "none", border: "none", color: "rgba(255,255,255,0.1)", cursor: "pointer", fontSize: "12px", fontFamily: "inherit" }}
          >
            ⚙
          </button>
        ) : (
          <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
            ...
            />
            <button onClick={handleAdminLogin} style={{ ...btn, width: "auto", padding: "10px 20px", marginTop: 0, fontSize: "14px" }}>
              دخول
            </button>
          </div>
        )}
